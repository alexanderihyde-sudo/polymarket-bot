...
const shipPrompt = (chosen) => R([
  ...
  '8. Append a dated entry to ~/polymarket-bot/QUANT_LOG.md: what shipped, the evidence, the test tally, and the rollback commit (HEAD~1) in case it must be reverted later.',
...
const discardPrompt = (note) => R([
  ...
  '4. Append ONE dated line to ~/polymarket-bot/QUANT_LOG.md: "AUTOPILOT: shipped nothing — ' + note.replace(/"/g, "'") + '".',
